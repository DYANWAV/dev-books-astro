...
const $$BookScore = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<span id="score" class="text-xs text-white">
Score: ${scoreValue}/5
</span>`;
}, "C:/Users/dyanwav/dev/17-astro-5/src/components/BookScore.astro", void 0);

const $$file = "C:/Users/dyanwav/dev/17-astro-5/src/components/BookScore.astro";
const $$url = undefined;
